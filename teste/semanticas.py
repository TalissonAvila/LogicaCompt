...
def sat(formula: Formula, lista_atomicas: set, interpretacao: dict):
    if not atomicas:
    ...
    resultadoT = sat(formula, lista_atomicas, interpretacao1)
    if resultadoT:
        return resultadoT

    resultadoF = sat(formula, lista_atomicas, interpretacao2)
    if resultadoF:
        return resultadoF
